...
class CriteoDataset(torch.utils.data.Dataset):
    ...
    :param min_threshold: infrequent feature threshold.
     ...
     You can get criteo dataset from this website
        https://labs.criteo.com/2014/02/kaggle-display-advertising-challenge-dataset
        https://www.csie.ntu.edu.tw/~r01922136/kaggle-2014-criteo.pdf
    """

    def __init__(self, dataset_path=None, cache_path='./dataset/criteo/.criteo_whole', rebuild_cache=False, min_threshold=10):
        self.NUM_FEATS = 39
        self.NUM_INT_FEATS = 13
        self.num_sparse_feats = 26
        self.num_dense_feats = 13
    ...
    def __build_cache(self, path, cache_path):
        ...
        with lmdb.open(cache_path, map_size=int(5e9)) as env:
